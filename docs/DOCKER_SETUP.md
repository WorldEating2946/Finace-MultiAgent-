...
```bash
# 模板默认 POSTGRES_USER=finance / POSTGRES_PASSWORD=finance123
# 若你改过这些，下面两行 DSN 要同步改
DATABASE_URL=postgresql://finance:finance123@localhost:5433/finance_agent
CHECKPOINT_DB_URL=postgresql://finance:finance123@localhost:5433/finance_agent
...
|------|-----------|----------|-------------|-----------|
| PostgreSQL | 5433 | 5432 | `postgres` | `postgresql://finance:finance123@localhost:5433/finance_agent` |
